...
const stoneFloorPng = '/threejs/textures/stone-floor-texture.png'
const wallPng = '/threejs/textures/wall-texture.png'
const waterPng = '/threejs/textures/water-texture.png'
const pitPng = '/threejs/textures/pit-texture.png'
const doorwayPng = '/threejs/textures/doorway-texture.png'
